...
type Row = DepartmentRecord & { selection_id: number; application_id: number; candidate_name: string; email: string; vacancy_title: string; status: string; approved_at?: string; interview_score: number | string | null; interview_recommendation: string | null; interview_comments: string | null };
...
export default function SelectionsPage() {
  ...
  return <main className="dashboard-page"><div className="app-wrapper rms-adminlte">
    ...
    <section className="app-main"><header className="app-header"><span className="app-header__title">Final selection</span><span className="app-header__meta">{user.name}<button className="dashboard-signout" onClick={() => { sessionStorage.removeItem('rms_user'); sessionStorage.removeItem('rms_staff_token'); router.replace('/'); }}>Sign out</button></span></header><div className="content-wrapper">

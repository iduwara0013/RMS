...
type Vacancy = { application_form?: VacancyForm | null; vacancy_id: number; title: string; description: string; vacancy_type: string; opening_date: string; closing_date: string };
...
export default function ApplyPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    body.append('cv', cv);
    const response = await fetch(`${API}/vacancies/${id}/applications`, { method: 'POST', headers: { Accept: 'application/json' }, body });
    const payload = await response.json().catch(() => ({})) as ApiResponse;
    ...
    } catch { setMessage('Unable to submit. Check your connection and try again.'); }
